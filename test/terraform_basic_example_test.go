...
// An example of how to test the simple Terraform module in examples/terraform/terraform-basic-example using Terratest.
func TestTerraformBasicExample(t *testing.T) {
	...
	terraformOptions := terraform.WithDefaultRetryableErrors(t, &terraform.Options{
		...
		TerraformDir: "../examples/terraform/terraform-basic-example",
